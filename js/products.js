/* ==========================================
   ANO Store - Supabase Live Dynamic Products Script
   ========================================== */
  ...
  /* ================= 3. إنشاء كارت المنتج القابل للضغط ================= */
  function createProductCardHTML(product) {
    ...
    return `
      <div class="col">
        <div class="product-card-sm position-relative" style="cursor: pointer;" onclick="window.location.href='product?id=${product.id}'">
          <a href="product?id=${product.id}" class="text-decoration-none text-dark d-block">
            <div class="img-box">
