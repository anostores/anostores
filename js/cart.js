       ...
       tbody.innerHTML = `
         <tr>
           <td colspan="5" class="text-center py-5 text-muted">
             ...
             <a href="index.html" class="btn btn-sm btn-danger rounded-pill mt-2">تصفح المنتجات والتسوق الآن</a>
           </td>
         </tr>
       `;
   ...
   async function handleCheckoutSubmit(e) {
     ...
     try {
       ...
       Swal.fire({
         ...
         window.location.href = res.isConfirmed ? "profile.html" : "index.html";
       });
